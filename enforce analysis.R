...
plot1<-autoplot(p1, xlab="Local rulemaking (%)", ylab="Partial dependence", aes(size=1))+ylim(0, 0.8) + 
  theme(legend.position="none") +theme(axis.text = element_text(size=10))+theme(axis.title=element_text(size=12))+
  theme(panel.border = element_rect(fill=NA) )+theme(panel.background = element_blank())+
  theme(axis.title=element_text(size=12))+theme(panel.background = element_blank())+
  theme(panel.border = element_rect(fill=NA))+
  ggtitle("(A)")
plot2<-autoplot(p2, xlab="Distance to market (minutes)", ylab="Partial dependence", aes(size=1))+ylim(0, 0.8)+ 
  theme(legend.position="none") +theme(axis.text = element_text(size=10))+theme(axis.title.y = element_blank())+
  theme(axis.text.y = element_blank())+ theme(panel.background = element_blank())+
  theme(panel.border = element_rect(fill=NA) )+ ggtitle("(B)")
...
plot3<-autoplot(p3, xlab="Group size (households)", ylab="Partial dependence", aes(size=1))+ylim(0, 0.8) +  
  ...
  theme(axis.title=element_text(size=12))+theme(panel.border = element_rect(fill=NA) )+
  theme(panel.background = element_blank())+theme(axis.title=element_text(size=12))+
  theme(panel.border = element_rect(fill=NA) )+
  theme(axis.title.y = element_blank())+theme(axis.text.y = element_blank())+ggtitle("(C)")
plot4<-autoplot(p4, xlab="College education (%)", ylab="Partial dependence", aes(size=1))+ylim(0, 0.8) +  theme(legend.position="none") +
  theme(axis.text = element_text(size=10))+theme(axis.title=element_text(size=12))+theme(panel.border = element_rect(fill=NA) )+
  theme(panel.background = element_blank()) + ggtitle("(D)")
plot5<-ggplot(p5, aes(x=Uleader, y=yhat))+ xlab("Leadership")+ ylab("Partial dependence")+
  ...
  scale_x_discrete(labels=c("0"="No", "1"= "Yes"))+ ggtitle("(E)")+ theme(axis.title.y = element_blank())+
  theme(axis.text.y = element_blank())
plot6<-autoplot(p6, xlab="Interest heterogeneity index", ylab="Partial dependence", aes(size=1)) +ylim(0, 0.8) +  
  theme(legend.position="none") +theme(axis.text = element_text(size=10))+theme(axis.title=element_text(size=12))+
  theme(panel.border = element_rect(fill=NA) )+theme(panel.background = element_blank()) +theme(axis.title.y = element_blank())+
  theme(axis.text.y = element_blank())+ ggtitle("(F)")
plot7<-autoplot(p7, xlab="Literacy (%)", ylab="Partial dependence", aes(size=1))+ylim(0, 0.8) +  theme(legend.position="none") +theme(axis.text = element_text(size=10))+theme(axis.title=element_text(size=12))+theme(panel.border = element_rect(fill=NA) )+theme(panel.background = element_blank())
plot8<-autoplot(p8, xlab=" Forest size (ha)", ylab="Partial dependence", aes(size=1))+ylim(0, 0.8) +  theme(legend.position="none") +theme(axis.text = element_text(size=10))+theme(axis.title=element_text(size=12))+theme(panel.border = element_rect(fill=NA) )+theme(panel.background = element_blank())
plot9<-autoplot(p9, xlab="Economic heterogeneity index", ylab="Partial dependence", aes(size=1))+ylim(0, 0.8) +  theme(legend.position="none") +theme(axis.text = element_text(size=10))+theme(axis.title=element_text(size=12))+theme(panel.border = element_rect(fill=NA) )+theme(panel.background = element_blank())
plot10<-autoplot(p10, xlab="Poverty (%)", ylab="Partial dependence", aes(size=1))+ylim(0, 0.8) +  theme(legend.position="none") +theme(axis.text = element_text(size=10))+theme(axis.title=element_text(size=12))+theme(panel.border = element_rect(fill=NA) )+theme(panel.background = element_blank())
plot11<-autoplot(p11, xlab="Subsistence dependence (%)", ylab="Partial dependence", aes(size=1))+ylim(0, 0.8) +  theme(legend.position="none") +theme(axis.text = element_text(size=10))+theme(axis.title=element_text(size=12))+theme(panel.border = element_rect(fill=NA) )+theme(panel.background = element_blank())
plot12<-autoplot(p12, xlab="Land ownership (%)", ylab="Partial dependence", aes(size=1))+ylim(0, 0.8) +  theme(legend.position="none") +theme(axis.text = element_text(size=10))+theme(axis.title=element_text(size=12))+theme(panel.border = element_rect(fill=NA) )+theme(panel.background = element_blank())
plot13<-ggplot(p13, aes(x=Uganda, y=yhat))+ xlab("Uganda")+ ylab("Partial dependence")+ylim(0, 0.8)+geom_bar(stat="identity", fill="black") + theme(legend.position="none") +theme(axis.text = element_text(size=10))+theme(axis.title=element_text(size=12))+theme(panel.background = element_blank())+theme(panel.border = element_rect(fill=NA))+scale_x_discrete(labels=c("0"="No", "1"= "Yes"))
plot14<-ggplot(p14, aes(x=Nepal, y=yhat))+ xlab("Nepal")+ ylab("Partial dependence")+ylim(0, 0.8)+geom_bar(stat="identity", fill="black") + theme(legend.position="none") +theme(axis.text = element_text(size=10))+theme(axis.title=element_text(size=12))+theme(panel.background = element_blank())+theme(panel.border = element_rect(fill=NA))+scale_x_discrete(labels=c("0"="No", "1"= "Yes"))
plot15<-autoplot(p15, xlab="Social capital index", ylab="Partial dependence", aes(size=1))+ylim(0, 0.8) +  theme(legend.position="none") +theme(axis.text = element_text(size=10))+theme(axis.title=element_text(size=12))+theme(panel.border = element_rect(fill=NA) )+theme(panel.background = element_blank())
plot16<-ggplot(p16, aes(x=Others, y=yhat))+ xlab("Other groups")+ ylab("Partial dependence")+ylim(0, 0.8)+geom_bar(stat="identity", fill="black") + theme(legend.position="none") +theme(axis.text = element_text(size=10))+theme(axis.title=element_text(size=12))+theme(panel.background = element_blank())+theme(panel.border = element_rect(fill=NA))+scale_x_discrete(labels=c("0"="No", "1"= "Yes"))
plot17<-ggplot(p17, aes(x=Statefor, y=yhat))+ xlab("State forest")+ ylab("Partial dependence")+ylim(0, 0.8)+geom_bar(stat="identity", fill="black") + theme(legend.position="none") +theme(axis.text = element_text(size=10))+theme(axis.title=element_text(size=12))+theme(panel.background = element_blank())+theme(panel.border = element_rect(fill=NA))+scale_x_discrete(labels=c("0"="No", "1"= "Yes"))
plot18<-ggplot(p18, aes(x=India, y=yhat))+ xlab("India")+ ylab("Partial dependence")+ylim(0, 0.8)+geom_bar(stat="identity", fill="black") + theme(legend.position="none") +theme(axis.text = element_text(size=10))+theme(axis.title=element_text(size=12))+theme(panel.background = element_blank())+theme(panel.border = element_rect(fill=NA))+scale_x_discrete(labels=c("0"="No", "1"= "Yes"))
plot19<-ggplot(p19, aes(x=Kenya, y=yhat))+ xlab("Kenya")+ ylab("Partial dependence")+ylim(0, 0.8)+geom_bar(stat="identity", fill="black") + theme(legend.position="none") +theme(axis.text = element_text(size=10))+theme(axis.title=element_text(size=12))+theme(panel.background = element_blank())+theme(panel.border = element_rect(fill=NA))+scale_x_discrete(labels=c("0"="No", "1"= "Yes"))
plot20<-ggplot(p20, aes(x=Mad, y=yhat))+ xlab("Madagascar")+ ylab("Partial dependence")+ylim(0, 0.8)+geom_bar(stat="identity", fill="black") + theme(legend.position="none") +theme(axis.text = element_text(size=10))+theme(axis.title=element_text(size=12))+theme(panel.background = element_blank())+theme(panel.border = element_rect(fill=NA))+scale_x_discrete(labels=c("0"="No", "1"= "Yes"))
...
pdp1<-partial(gbm.monitor1, pred.var=c("smkttradry", "literate"), prob=TRUE, 
              trim.outliers = TRUE, chull=TRUE, n.trees=1600)
pdp2<-partial(gbm.monitor1, pred.var=c("smkttradry", "Uleader"), prob=TRUE, 
              trim.outliers = TRUE, n.trees=1600)

pdp3<-partial(gbm.monitor1, pred.var=c("uhhnum", "Uleader"), 
              prob=TRUE, trim.outliers = TRUE, n.trees=1600)

pdp3plot <- pdp3 %>%
  mutate(Leader = if_else(Uleader == 0, 'No', 'Yes'))
...
pdpplot2<- ggplot(data=pdp2, aes(x=smkttradry,y=yhat, group=Uleader)) +  
  geom_line(aes(linetype = Uleader))+xlab("Distance to market (minutes)")+ 
  ylab("Partial dependence")+ theme(axis.text = element_text(size=10))+
  theme(axis.title=element_text(size=12))+ theme(panel.background = element_blank())+
...
corrplot(M, method="color", type="lower", tl.cex=0.9, addCoef.col = "black", number.cex=0.7, tl.col="black", tl.srt=20, tl.offset=0.6)
